...
- Replace stale `pytest_notebook` with `nbmake` for example notebook testing (fixes incompatibility with matplotlib >= 3.11) [#171](https://github.com/umami-hep/atlas-ftag-tools/pull/171)
