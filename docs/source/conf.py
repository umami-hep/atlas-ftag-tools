...
#
json_url = "https://umami-hep.github.io/atlas-ftag-tools/_static/switcher.json"
release = __version__
...
commits = requests.get("https://api.github.com/repos/umami-hep/atlas-ftag-tools/commits/main")
...
html_theme_options = {
    "external_links": [
        {
            "url": "https://github.com/umami-hep/atlas-ftag-tools/blob/main/changelog.md",
            "name": "Changelog",
        },
    ],
    "logo": {
        "text": "atlas-ftag-tools documentation",
    },
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/umami-hep/atlas-ftag-tools",
